...
1. Make copies of:  
 * previous year's Lane County set-up 
 * update scripts 
 * and Oregon SOS update script. (There is no Oregon SOS set-up script as all the relevant races are in the Lane County races list.)
